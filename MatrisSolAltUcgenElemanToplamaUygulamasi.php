...
for ($i = 0; $i < $eleman; $i++) {
    for ($j = 0; $j < $eleman; $j++) {
        ...
        // Sol alt üçgende yer alan elemanlar toplama ekleniyor
        if ($i>$j) {
            $toplam += $dizi[$i][$j];
        }
    }
...
// Sol alt üçgen şeklinde yer alan elemanların toplamını yazdırıyoruz.
echo "Sol alt üçgen şeklindeki elemanların toplamı: " . $toplam . "\n";
?>
