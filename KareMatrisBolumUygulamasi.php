...
// Matrislerin bölümünü ( Matris1/ Matris2) hesaplıyoruz ve üçüncü matrise kaydediyoruz.
for ($i = 0; $i < $eleman; $i++) {
    for ($j = 0; $j < $eleman; $j++) {
        // İki matrisin karşılık gelen elemanlarını bölüyoruz.
        $dizi3[$i][$j] = $dizi1[$i][$j] / $dizi2[$i][$j];
    }
}

// Matrisin bölümünü ekrana yazdırıyoruz.
echo "Girilen matrislerin bölüm (Matris1 / Matris2) sonucu oluşan matris: \n";
for ($i = 0; $i < $eleman; $i++) {
    for ($j = 0; $j < $eleman; $j++) {
