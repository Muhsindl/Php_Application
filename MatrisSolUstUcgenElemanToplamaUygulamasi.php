...
for ($i = 0; $i < $eleman; $i++) {
    for ($j = 0; $j < $eleman; $j++) {
        ...
        // Sol üst üçgende yer alan elemanlar toplama ekleniyor
        if ($i+$j<$eleman-1) {
            $toplam += $dizi[$i][$j];
        }
    }
...
// Sol üst üçgen şeklinde yer alan elemanların toplamını yazdırıyoruz.
echo "Sol üst üçgen şeklindeki elemanların toplamı: " . $toplam . "\n";
?>
