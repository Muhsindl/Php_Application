...
for ($i = 0; $i < $eleman; $i++) {
    for ($j = 0; $j < $eleman; $j++) {
        ...
        // Sağ alt üçgende yer alan elemanlar toplama ekleniyor
        if ($eleman<=$i+$j) {
            $toplam += $dizi[$i][$j];
        }
    }
...
// Sağ alt üçgen şeklinde yer alan elemanların toplamını yazdırıyoruz.
echo "Sağ alt üçgen şeklindeki elemanların toplamı: " . $toplam . "\n";
?>
